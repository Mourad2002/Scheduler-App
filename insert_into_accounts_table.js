...
const dbCon = mysql.createConnection({
    ...
    user: "C4131S24NU59",               // replace with the database user provided to you
    password: "3531",                  // replace with the database password provided to you
    database: "C4131S24NU59",           // replace with the database user provided to you
    port: 3306
});
